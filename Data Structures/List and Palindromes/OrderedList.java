...
public class OrderedList
{
    ...
    private boolean isPalindrome(String value)
    {
        ...
        // Compares letters at either side of the string
    ...
    {
        // Searches for palindromes in the list and removes them

        int pointer = head;
        while (pointer != -1)
        {
            int nextPointer = linkList[pointer];
            if (isPalindrome(dataList[pointer])) { remove(dataList[pointer]); }
            pointer = nextPointer;
        }
    }
